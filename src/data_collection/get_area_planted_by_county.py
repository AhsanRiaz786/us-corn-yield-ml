...
class USDAQuickStats:
    ...
    def download_csv(self, uuid, year, output_dir="data"):
        ...
        output_file = f"{output_dir}/corn_area_planted_{year}.csv"
    ...
    def get_corn_area_planted_data(self, start_year=1866, end_year=2026):
        """
        Get corn area planted data at county level for all years
    ...
    def merge_csv_files(self, file_list, output_file="us_corn_area_planted_county_all_years.csv"):
...
def main():
    ...
    print("="*60)
    print("USDA NASS QuickStats - Corn Area Planted Data Collector")
    print("="*60)
    print("\nQuery Parameters:")
    ...
    downloaded_files = scraper.get_corn_area_planted_data(start_year=1911, end_year=2025)
