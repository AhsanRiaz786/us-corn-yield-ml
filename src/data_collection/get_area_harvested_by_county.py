...
class USDAQuickStats:
    ...
    def get_uuid(self, params):
        ...
        if 'statisticcat_desc' in params:
            breadcrumb_order.append('statisticcat_desc')
    ...
    def download_csv(self, uuid, year, output_dir="data"):
        ...
        output_file = f"{output_dir}/corn_area_harvested_{year}.csv"
    ...
    def get_corn_area_harvested_data(self, start_year=1866, end_year=2026):
        """
        Get corn area harvested data at county level for all years
    ...
    def merge_csv_files(self, file_list, output_file="us_corn_area_harvested_county_all_years.csv"):
...
def main():
    ...
    print("="*60)
    print("USDA NASS QuickStats - Corn Area Harvested Data Collector")
    print("="*60)
    print("\nQuery Parameters:")
    ...
    print("  - Category: AREA HARVESTED")
    print("  - Geographic Level: COUNTY")
    print("  - Years: 1919-2025")
    print("="*60)
    ...
    # Starting from 1919 as that's when county-level data typically starts
    downloaded_files = scraper.get_corn_area_harvested_data(start_year=1919, end_year=2025)
