...
class USDAQuickStats:
    ...
    def download_csv(self, uuid, year, output_dir="data"):
        ...
        output_file = f"{output_dir}/corn_production_{year}.csv"
    ...
    def get_corn_production_data(self, start_year=1911, end_year=2025):
        """
        Get corn production data at county level for all years
...
def main():
    ...
    downloaded_files = scraper.get_corn_production_data(start_year=1911, end_year=2025)
